...
ff=pd.concat([ff1.istep,ff1.time,ff1.F_top, ff1.F_bot,ff1.Tmean,ff1.Nu_top,ff1.Nu_bot,ff1.ra_eff, ff17],axis=1)
ff.to_csv(path+model+'_scaling_time_data.csv',index=False)  
