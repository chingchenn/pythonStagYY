...
# 
fig,(aa1,aa2) = plt.subplots(2,2,figsize=(17,11))
ax=aa1[0]
ax2=aa2[0]
axx=aa1[1]
axx3=aa2[1]
...
for i, model in enumerate(model_list):
    ...
    min_zbot.append(np.min(pp1))
    max_zbot.append(np.max(pp2))
...
for aa in [axx,axx3]:
    ...
    for axis in ['top','bottom','left','right']:
        aa.spines[axis].set_linewidth(bwith)
    aa.grid()
# fig.savefig('/Users/chingchen/Desktop/StagYY_Works/paper_europa_ice_shell/figureS4_v6.pdf')