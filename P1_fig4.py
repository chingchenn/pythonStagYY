...
# model_list = ['Europa-tidal5_period0.14Gyr_emx10%_eta1.0d13_P0.6TW_1.5wt%_D5.0km-NH3', # power
#               'Europa-tidal5_period0.14Gyr_emx10%_eta1.0d13_P0.8TW_1.5wt%_D5.0km-NH3',
#               'Europa-tidal5_period0.14Gyr_emx10%_eta1.0d13_P1.0TW_1.5wt%_D5.0km-NH3',
#               'Europa-tidal5_period0.14Gyr_emx10%_eta1.0d13_P1.2TW_1.5wt%_D5.0km-NH3',]
...
# model_list = ['Europa-tidal1_eta3.2d13_P0.6TW_1.5wt%-NH3', # power
#               'Europa-tidal1_eta3.2d13_P0.8TW_1.5wt%-NH3',
...
for aa in [axx]:
    axx.set_xlabel('Internal power (TW)',fontsize=labelsize)
    for axis in ['top','bottom','left','right']:
        aa.spines[axis].set_linewidth(bwith)
    aa.grid()
fig.savefig('/Users/chingchen/Desktop/StagYY_Works/figure/figure4_v3.pdf')