...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep  7 20:48:12 2023
...
if fig_ftime:
    ...
    ax2.plot(ff.time,ff.F_bot,color='#AE6378',label = 'F_bot')
...
raeff = rsurf*(1+Rt*average_t)*np.exp(gamma*average_t)
...
print('##############################################################')
print(model,round(rsurf,3),round(Ea,3),round(Rk,3),round(Tmm,3),round(kmm,3),
      round(phi_conv,3),round(average_Nu_bot,3),round(raeff,3),round(dlid,3),round(Tlid,3))
